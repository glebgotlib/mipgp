...
static pk_cache_entry_t pk_cache = NULL;
static int pk_cache_entries = 0;	 /* number of entries in pk cache */
static int pk_cache_disabled = 0;
#endif
...
#if MAX_PK_CACHE_ENTRIES
    {
        pk_cache_entry_t ce = NULL, ce2 = NULL;
...
pk_from_block ( GETKEY_CTX ctx, PKT_public_key *pk, KBNODE keyblock )
{
    PRINT_FUNC;
    KBNODE a = NULL;
    a = ctx->found_key ? ctx->found_key : keyblock;
...
fixup_uidnode ( KBNODE uidnode, KBNODE signode, u32 keycreated )
{
    ...
    const byte *p = NULL, *sym = NULL, *hash = NULL, *zip = NULL;
    size_t n = 0, nsym = 0, nhash = 0, nzip = 0;
...
merge_selfsigs_main(KBNODE keyblock, int *r_revoked, struct revoke_info *rinfo)
{
    ...
    KBNODE signode = NULL, uidnode = NULL, uidnode2 = NULL;
...
merge_selfsigs( KBNODE keyblock )
{
    ...
    PKT_public_key *main_pk = NULL;
    prefitem_t *prefs = NULL;
    int mdc_feature = 0;
...
parse_auto_key_locate(char *options)
{
    ...
    {
        struct akl *akl = NULL,*check=NULL,*last=NULL;
        int dupe=0;
