...
int
mi_keyserver_recv(char *srv, char *fpr, mi_imported_t **ilist);
int
mi_keyserver_name(char *srv, char *search, mi_imported_t **ilist); 
int
mi_keyserver_send(char *srv, char *fpr); 
int
mi_keyserver_search(char *srv, char *search, list_key_t **lskeys); 
